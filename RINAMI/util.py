...
def load_garcia_benchmark_dataset(seq_len_threshold=300):
    ...
    df = pd.read_csv("../processed_data/csv/Garcia_zero_shot_clean_no_megascale_homologs.csv")

    if "Name" not in df.columns:
        raise KeyError("'Name' column was not found in ../processed_data/csv/Garcia_zero_shot_clean_no_megascale_homologs.csv")
    ...
    if "ESMFold_pLDDT" not in df.columns:
        raise KeyError("'ESMFold_pLDDT' column was not found in ../processed_data/csv/Garcia_zero_shot_clean_no_megascale_homologs.csv")
